...
public class CreateVibrantVaultsDatagen {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        generator.addProvider(event.includeServer(), new CreateVibrantVaultsRecipeProvider(output, lookupProvider));

        generator.addProvider(true, CreateVibrantVaults.REGISTRATE.setDataProvider(new RegistrateDataProvider(CreateVibrantVaults.REGISTRATE, CreateVibrantVaults.ID, event)));
    }
